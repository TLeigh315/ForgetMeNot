    ...
    try:
        while (True):
            ...
            if (App_Latitude == "\r" and App_Longitude == "\r"): #Disconnected from App begin Temp/Timer alert procedure
                ...
                base_temp = checkchild['base_temp']
                timer = checkchild['BLEtimer']
        ...
        if (address == ('50:77:05:A7:B3:99', 1)): #if connected to phone
            ...
            while (True):
                try:
                    ...
                    if GPIO.input(BLEoffbutton) == 1: break #break loop begin checking if phone has reconnected
                except:
