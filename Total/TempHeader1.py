...
class alert():
    ...
    def EMS_warning_alert(self, serial):
        print("Your child is alone in a hot car. Please return to your car. EMS will be contacted in 60 seconds.")
...
class accelerometer_sensor() :
    ...
    def Accelerometer_sensor(self, serial, timer, reed_input, movingcar, last_alert, start_program, lastx, lasty, lastz):
        ...
        if accelerometer_sensor.rateAccel(self, movingcar, x, y, z, lastx, lasty, lastz) == 1 :
